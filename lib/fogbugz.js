...
FogBugz.prototype.resolveCase = function(caseID, token, location, callback) {
...
FogBugz.prototype.closeCase = function(caseID, token, location, callback) {
...
FogBugz.prototype.timeIntervals = function(fromDate, location, token, callback) {
  var dateString = fromDate.getFullYear() + '-' + (fromDate.getMonth() + 1) + '-' + fromDate.getDay();
